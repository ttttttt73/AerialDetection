...
def prepare(srcpath, dstpath):
    ...
    if not os.path.exists(os.path.join(dstpath, 'val1024_ms')):
        os.mkdir(os.path.join(dstpath, 'val1024_ms'))
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024'), os.path.join(dstpath, 'trainval1024', 'DOTA_trainval1024.json'), wordname_roof, difficult='2')
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024_ms'), os.path.join(dstpath, 'trainval1024_ms', 'DOTA_trainval1024_ms.json'), wordname_roof, difficult='2')

    DOTA2COCOTrain(os.path.join(dstpath, 'val1024'), os.path.join(dstpath, 'val1024', 'DOTA_val1024.json'), wordname_roof, difficult='2')
    DOTA2COCOTrain(os.path.join(dstpath, 'val1024_ms'), os.path.join(dstpath, 'val1024_ms', 'DOTA_val1024_ms.json'), wordname_roof, difficult='2')

    # DOTA2COCOTest(os.path.join(dstpath, 'test1024'), os.path.join(dstpath, 'test1024', 'DOTA_test1024.json'), wordname_roof)
    # DOTA2COCOTest(os.path.join(dstpath, 'test1024_ms'), os.path.join(dstpath, 'test1024_ms', 'DOTA_test1024_ms.json'), wordname_roof)
