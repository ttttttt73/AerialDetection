...
def main():
    ...
    detpath = r'../work_dirs/faster_rcnn_r50_fpn_1x_dota_roof/Task1_results/{:s}.txt'
    annopath = r'../data/h_dota_format1_1024_val/val1024/labelTxt/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'../data/imagesetfile.txt'
    print(os.path.isfile(imagesetfile))
    print(os.path.abspath(annopath))
    print(os.path.abspath(imagesetfile))
    # For DOTA-v1.5
    # classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
    #             'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter', 'container-crane']
    # For DOTA-v1.0
    classnames = ['facility', 'rooftop', 'flatroof', 'solarpanel_flat', 'solarpanel_slope', 'parkinglot', 'heliport']
    classaps = []
    map = 0
