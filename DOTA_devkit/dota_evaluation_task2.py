...
def main():
    ...
    detpath = r'../work_dirs/val_with_label/Task2_results/{:s}.txt'
    annopath = r'../data/val_with_label/val1024/labelTxt/{:s}.txt'# change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
