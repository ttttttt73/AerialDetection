...
if __name__ == '__main__':
    roitransformer = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r50_fpn_1x_dota_gap512_msTrainTest_rotationTrainTest.py', r'work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota_gap512_msTrainTest_rotationTrainTest/epoch_12.pth')
    import argparse
    import os

    parser = argparse.ArgumentParser(description='Demo inference')
    ...
    for fname in dir_list:
        if allowed_file(fname):
            srcpath = os.path.join(args.input, fname)
            dstpath = os.path.join(args.output, fname.rsplit(".", 1)[0]+"_out."+fname.rsplit(".", 1)[1])
            roitransformer.inference_single_vis(srcpath, dstpath, (512, 512), (1024, 1024))

    # roitransformer.inference_single_vis(r'demo/P0009.jpg', r'demo/P0009_out.jpg', (512, 512), (1024, 1024))
